...
//    // Views for animation
//    private CardView logoContainer;
//    private ImageView ivLogo;  // 🔥 PROFILE LOGO
//    private LinearLayout nameContainer;
//    private View nameUnderline;
//    private TextView tagline;
//    private ProgressBar progressBar;
...
//        setContentView(R.layout.activity_splash);
//
//        Log.d(TAG, "🚀 SplashActivity - LOADING PROFILE LOGO");
//
//        initViews();
//        loadProfileLogo();  // 🔥 LOAD LOGO FIRST
//        startAnimations();
//
//        new Handler(Looper.getMainLooper()).postDelayed(this::decideNextActivity, SPLASH_DELAY);
//    }
...
//    private void initViews() {
//        logoContainer = findViewById(R.id.logo_container);
//        ivLogo = findViewById(R.id.iv_logo);  // 🔥 YOUR LOGO IMAGEVIEW ID
//        nameContainer = findViewById(R.id.name_container);
//        nameUnderline = findViewById(R.id.name_underline);
//        tagline = findViewById(R.id.tv_tagline);
//        progressBar = findViewById(R.id.progress_bar);
...
//    }
//
//    // 🔥 LOAD PROFILE LOGO FROM FIREBASE (SAME AS ProfileFragment)
//    private void loadProfileLogo() {
//        PrefManager prefManager = new PrefManager(this);
//        String email = prefManager.getUserEmail();
//
//        if (email == null || email.isEmpty()) {
//            Log.d(TAG, "No user email - using default logo");
//            setDefaultLogo();
//            return;
//        }
//
...
//
//        // 🔥 SAME LOGIC AS ProfileFragment - MULTI-SHOP SUPPORT
...
//        }
//
//        Log.d(TAG, "🔄 Loading profile logo from: " + profileRef.toString());
//
...
//                    Log.d(TAG, "✅ Found logoUrl: " + (logoUrl != null ? logoUrl.substring(0, 50) + "..." : "null"));
//
//                    if (logoUrl != null && !logoUrl.isEmpty()) {
//                        // 🔥 LOAD PROFILE LOGO WITH GLIDE (SAME AS ProfileFragment)
...
//                                .into(ivLogo);
//                        Log.d(TAG, "✅ PROFILE LOGO LOADED IN SPLASH!");
//                    } else {
//                        setDefaultLogo();
//                    }
//                } else {
...
//            @Override
//            public void onCancelled(@NonNull DatabaseError error) {
//                Log.e(TAG, "Logo load failed: " + error.getMessage());
//                setDefaultLogo();
//            }
//        });
//    }
...
//        animateCircles();
//
//        // 🔥 LOGO ANIMATION - Scale, Rotate, Fade (AFTER LOGO LOADS)
