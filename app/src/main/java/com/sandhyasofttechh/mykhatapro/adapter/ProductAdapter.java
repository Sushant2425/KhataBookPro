...
//        holder.tvUnit.setText("Unit: " + p.getUnit());
//
//        double stock = p.getOpeningStockDouble();
//        holder.tvStock.setText(String.format(Locale.getDefault(), "Stock: %.2f %s", stock, p.getUnit()));
//
//        holder.tvPrices.setText("Sale: ₹" + p.getSalePrice() + " | Purchase: ₹" + p.getPurchasePrice());
//
//        // Initial
//        if (name != null && !name.isEmpty()) {
//            holder.tvInitial.setText(name.substring(0, 1).toUpperCase(Locale.getDefault()));
//        } else {
...
//
//        TextView tvInitial, tvName, tvUnit, tvStock, tvPrices;
//
