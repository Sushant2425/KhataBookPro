...
public class CustomerAdapter extends RecyclerView.Adapter<CustomerAdapter.ViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull CustomerAdapter.ViewHolder holder, int position) {
        ...
        // Click listener for the whole item and forward icon
        View.OnClickListener clickListener = v -> listener.onItemClicked(customer);
        holder.itemView.setOnClickListener(clickListener);
        holder.ivForwardIcon.setOnClickListener(clickListener);
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            tvName = itemView.findViewById(R.id.tv_customer_name);
            ivForwardIcon = itemView.findViewById(R.id.iv_forward_icon);
        }
    }
}
